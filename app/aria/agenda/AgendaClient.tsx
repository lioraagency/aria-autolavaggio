...
export default function AgendaClient({ initialBookings, customerMap, vehicleMap }: Props) {
  ...
  const handleSmsSend = async (bookingId: string) => {
    ...
    const customer = booking ? (customerMap[booking.customerId] ?? getCustomer(booking.customerId)) : undefined;
